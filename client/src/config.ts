...
export const config = {
  ...
  SCREENSHARE_IDEAL_FPS: getEnv('VITE_SCREENSHARE_IDEAL_FPS', '90'),
  SCREENSHARE_MAX_FPS: getEnv('VITE_SCREENSHARE_MAX_FPS', '120'),
  SCREENSHARE_MAX_BITRATE_KBPS: getEnv('VITE_SCREENSHARE_MAX_BITRATE_KBPS', '25000'),
};
